...
user_role = sa.Enum("super_admin", "admin", "technician", name="userrole")
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_vehicles_serial_number"), "vehicles", ["serial_number"], unique=False)
    ...
    op.create_index(op.f("ix_company_analytics_id"), "company_analytics", ["id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_company_analytics_id"), table_name="company_analytics")
    op.drop_table("company_analytics")
    op.drop_index(op.f("ix_jobs_id"), table_name="jobs")
    op.drop_table("jobs")
    op.drop_index(op.f("ix_vehicles_vin"), table_name="vehicles")
    op.drop_index(op.f("ix_vehicles_serial_number"), table_name="vehicles")
